  ...
  .. tab:: Tutorial 1
     ...
     .. tabs::
        ...
        .. tab:: Exercise 1
           ...
           2. Download and import your `raw sequences  <https://owncloud.gwdg.de/index.php/s/WRiUHW68Zwgb7Mz>`_ to Geneious Prime.
        ...
        .. tab:: Exercise 2
           ...
           6. Upload the consensus files `here <https://owncloud.gwdg.de/index.php/s/MVCMWGxtZvQvBpH>`_.
  ...
  .. tab:: Tutorial 4
     ...
     .. tabs::
        ...
        .. tab:: Exercise
           ...
           2. Root both trees with the outgroup *Zercon*.
           3. Plot both trees in one graphic, with facing tip labels. **EF** with ``green`` and **18S** with ``yellowgreen`` tip labels.
